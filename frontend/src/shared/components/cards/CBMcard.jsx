    ...
    switch (variant) {
      ...
      case 'gradient':
        return {
          ...baseStyles,
          background:
            'linear-gradient(135deg, rgba(27, 54, 93, 0.05) 0%, rgba(0, 91, 150, 0.05) 100%)',
          border: '1px solid',
          borderColor: 'primary.light',
          '&:hover': interactive
            ? {
                background:
                  'linear-gradient(135deg, rgba(27, 54, 93, 0.1) 0%, rgba(0, 91, 150, 0.1) 100%)',
                transform: 'translateY(-2px)',
    ...
    >
      ...
      >
        ...
        {actions && (
          <>
            <Divider />
            <CardActions sx={{ p: 2, justifyContent: 'flex-end' }}>{actions}</CardActions>
          </>
        )}
      </Card>
    </motion.div>
